...
func get_rotations() -> Array[Array]:
	...
	[ Vector3(0,0,0), Vector3(0,-1,0), Vector3(1,0,0), Vector3(1,1,0) ], # RIGHT
	[ Vector3(0,0,0), Vector3(-1,0,0), Vector3(0,-1,0), Vector3(1,-1,0) ], # DOWN
	[ Vector3(0,0,0), Vector3(0,-1,0), Vector3(1,0,0), Vector3(1,1,0) ], # LEFT
	]
